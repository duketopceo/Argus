...
be reported to the project maintainer via GitHub private vulnerability
reporting at
<https://github.com/duketopceo/Argus/security/advisories/new> (choose a
non-security advisory type) or by opening a private discussion with
`@duketopceo`. All complaints will be reviewed and investigated promptly
...
1. **Correction** — private, written warning clarifying the violation and
   why the behavior was inappropriate.
2. **Warning** — a warning with consequences for continued behavior,
   including a specified period of no interaction with the people
   involved.
